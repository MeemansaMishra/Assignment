...
class HomePage extends Page {
     ...
     */
     ...
     public async clickMenus(qA:string, tA:string,pT:string,cS:string,dT:string){
    ...
    public async Enteralldetails(name: string, email: string, phone: string, website: string, message: string) {
